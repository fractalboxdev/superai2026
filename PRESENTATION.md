# PRESENTATION.md — landing page presentation conventions

How `apps/landing` presents content visually. The landing page must follow these rules; `.claude/skills/generate-arts/SKILL.md` (the illustration pipeline) defers to this document.
