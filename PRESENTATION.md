...
| --- | --- | --- | --- | --- |
| 1 | **Hook** | "Your agents working with your data, on your infra." Cold open: CEO brags → an intern asks the CEO's salary → it answers → *slap*: "why'd you give it all the access?" | Act 1 (one continuous ~12s gag; drop the Nucleus bit) | No |
